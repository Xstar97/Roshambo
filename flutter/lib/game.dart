...
_gameChoicesToImages(BuildContext context, GameChoices choices){
  switch (choices) {
    case GameChoices.Rock:
      return _image("rock.png");
    case GameChoices.Paper:
      return _image("paper.png");
    case GameChoices.Scissors:
      return _image("scissors.png");
    default:
      return _image("hands.png");
  }
}
  ...
  Widget build(BuildContext context) {
        ...
        children: gameChoices.map((value) {
          return InkWell(
            ...
            child: Container(
              ...
              child: Center(child: _gameChoicesToImages(context, value),),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(child: Text(S.of(context).gameModeLocal, textAlign: TextAlign.center,),),
      ),
      body: Center(
        child: gameView(),
      ),
